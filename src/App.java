  ...
  public static void main(String[] args) throws Exception {
    ...
    server.createContext(
        ...
        t -> {
          ...
          sb.append("• [CPU] Active Processors             : ")
              .append(Runtime.getRuntime().availableProcessors())
              .append(nl)
              .append("• [Mem] Current Heap Size (Committed) : ")
              .append(heapSize / unit)
              .append(" MiB")
              .append(nl)
              .append("• [Mem] Current Free memory in Heap   : ")
              .append(heapFreeSize / unit)
              .append(" MiB")
              .append(nl)
              .append("• [Mem] Currently used memory         : ")
              .append(heapUsedSize / unit)
              .append(" MiB")
              .append(nl)
              .append("• [Mem] Max Heap Size (-Xmx)          : ")
              .append(heapMaxSize / unit)
              .append(" MiB")
              .append(nl)
              .append("• [Thread] Virtual                    : ")
    ...
    out.printf(
        "Started in %d millis! (%s: %dms, App: %dms)%n",
        (currTime - vmTime), type, (start - vmTime), (currTime - start));
  }
}
